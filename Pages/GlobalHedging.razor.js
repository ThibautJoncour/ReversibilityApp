...
/**
 * Function called in the GlobalHeding.razor file to initialize the DataTable.
 */
export function init() {
     ...
     */
    $(document).ready(() => {
        dataTable = $("#global-hedging-table").DataTable({
            searchable: true,
            responsive: true,
            sortable: true,
            perPage: 10,
            ...
            labels: {
                ...
                info: "Showing {start} to {end} of {rows} data"
            }
        });
    });
